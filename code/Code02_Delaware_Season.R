...
model.params <- c("Mu_intercept","Mu_prec.conc","Mu_temp.conc","Mu_prec.lag",
                  "Mu_temp.lag","Sig_intercept","Sig_prec.conc",
                  "Sig_temp.conc","Sig_prec.lag","Sig_temp.lag")
model.params <- c("Mu_temp.lag","Sig_intercept","Sig_prec.conc",
                  "Sig_temp.conc","Sig_prec.lag","Sig_temp.lag")
model.param <- "Mu_prec.conc"
df.AIC = NULL
df.range <- data.frame(param=c("Mu_intercept","Mu_prec.conc","Mu_temp.conc","Mu_prec.lag",
                               "Mu_temp.lag","Sig_intercept","Sig_prec.conc",
                               "Sig_temp.conc","Sig_prec.lag","Sig_temp.lag"),
                       xmin=c(-5, -0.02, -0.2, -0.005, -0.1, -5, -0.01, -0.2, -0.005, -0.3),
                       xmax=c(5, 0.02, 0.2, 0.005, 0.1, 5, 0.01, 0.2, 0.005, 0.3))
